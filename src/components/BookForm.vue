<template>
  <form v-on:submit.prevent="bookSubmit(bookData)" class action="#" method="post">
    ...
    <div>
      ...
      <input v-model="bookData.ownership" value="borrowed" type="radio" /><label for="borrowed">borrowed</label>
      <input v-model="bookData.ownership" value="bought" type="radio" /><label for="bought">bought</label>
    </div>
